                    ...
                    let html = `<div>
                        <div class="pdf_options">
                            <button class="zoom_in">
                                <svg viewBox="0 0 ${icons["zoomIn"].width} ${icons["zoomIn"].height}" fill="${this.iconcolor}">
                                    ${icons["zoomIn"].svg}
                                </svg>
                            </button>
                            <button class="zoom_out">
                                <svg viewBox="0 0 ${icons["zoomOut"].width} ${icons["zoomOut"].height}" fill="${this.iconcolor}">
                                    ${icons["zoomOut"].svg}
                                </svg>
                            </button>
                            <button class="previous_page">
                                <svg viewBox="0 0 ${icons["arrowBack"].width} ${icons["arrowBack"].height}" fill="${this.iconcolor}">
                                    ${icons["arrowBack"].svg}
                                </svg>
                            </button>
                            <span>Page: <span class="page_num"/></span><span>/</span> <span class="page_count"></span></span>
                            <button class="next_page">
                                <svg viewBox="0 0 ${icons["arrowNext"].width} ${icons["arrowNext"].height}" fill="${this.iconcolor}">
                                    ${icons["arrowNext"].svg}
                                </svg>
                            </button>
                        </div>
                                ...
                                <div class="media_container" data-fullscreen="false">
                                    ...
                                    <div class="media_controls" data-state="hidden">
                                        <div class="playpause media_button" data-state="play">
                                            <svg viewBox="0 0 ${icons["playArrow"].width} ${icons["playArrow"].height}" fill="${this.iconcolor}">
                                                ${icons["playArrow"].svg}
                                            </svg>
                                        </div>
                                        ...
                                        <div class="volume_icon">
                                            <svg viewBox="0 0 ${icons["volumeUp"].width} ${icons["volumeUp"].height}" fill="${this.iconcolor}">
                                                ${icons["volumeUp"].svg}
                                            </svg>
                                        </div>
                                        <div class="volume">
                                ...
                                <div class="media_container" data-fullscreen="false">
                                    ...
                                    <div class="media_controls" data-state="hidden">
                                        ...
                                        <div class="fs media_button" data-state="go-fullscreen">
                                            <svg viewBox="0 0 ${icons["fullscreen"].width} ${icons["fullscreen"].height}" fill="${this.iconcolor}">
